...
const DoctorList = ({ doctorList,heading="Popular Doctors" }) => {
    return (<div className="mb-10 px-10">
        <h2 className="font-bold text-xl">{heading} </h2>
        <div className="grid grid-cols-2 sm:grid md:grid-col-3 lg:grid-cols-3 gap-7 mt-4">
            ...
            <div key={index} className="border-[1px] rounded-lg p-3 cursor-pointer hover:border-primary hover:shadow-sm transition-all ease-in-out">
                    <Image src={doctor.attributes?.image?.data.attributes.url} alt="doctor" width={500} height={200} className="h-[200px] w-full object-cover rounded" />
                    <div className="mt-3 items-baseline flex flex-col gap-1 ">
                        ...
                        <h2 className="text-gray-500 text-sm">{doctor.attributes?.Address} Years</h2>
